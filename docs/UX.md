...
> Индекс и легенда [И]/[ИИ]: [README.md](README.md). Потоки целиком — [USECASES.md](USECASES.md).
> Решения UX — **[И]**; конкретные детали оформления — **[ИИ]**.

## 1. Запуск: TUI-меню [И]

Каждый `mirabilis` открывает **TUI-меню** (`gum` [ИИ]-выбор инструмента): **обновить / войти / настройки**.

- **Подсветка устаревшего [И]:** меню показывает, что устарело — **workspace** (контейнер из старого
...
## 4. Согласие (консент-гейт) [И]

- **Инлайн в сессии:** запрос y/n прямо в диалоге. Механизм — [CONSENT.md](CONSENT.md).

## 5. Ошибки: fail-fast (I7), зависит от компонента (F3) [И]
