...
> **Список юзкейсов — [И] (перечислены владельцем). Потоки и пути — [ИИ] (детализация ассистента).**
...
| # | Юзкейс [И] | Стек/инструменты | Где работа [ИИ] | Память |
|---|---|---|---|---|
...
Принцип «структурированная песочница» [И]; конкретные папки [ИИ] (см. выше).

## UC1 — Разработка своих проектов [И]
...
## UC2 — Развитие neuro-matrix (харнес) [И]
...
## UC3 — Мультистек (Python / React / .NET) [И]
...
## UC4 — Подготовка к собеседованиям [И]
